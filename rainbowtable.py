...
#this contains the rainbow table class.
#Much credit goes to github user bobctr for providing a lot of the framework for this.
#For now, this code is a lot more copy and paste than i would like it to be. In the near future,
#while i am working on adjusting certain parts of the alogrithm, a lot of the copy and paste will also change.
#github.com/bobctr
